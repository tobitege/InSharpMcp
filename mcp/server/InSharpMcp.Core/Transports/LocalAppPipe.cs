...
internal static class LocalAppPipe
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var response = await ReadLineAsync<TResponse>(pipe, timeoutSource.Token).ConfigureAwait(false);
        return response ?? throw new InvalidOperationException("The local app transport returned an empty response.");
    }
